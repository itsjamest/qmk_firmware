...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
        KC_2, KC_2, KC_PAUS, KC_SCRL, KC_PSCR, KC_ESC,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
        ...
        C(LALT(KC_S)),    KC_8,    KC_UP,   KC_LSFT, KC_BSLS, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_LSFT,
        LALT(KC_COMMA),    LALT(KC_DOT),    KC_LEFT, KC_DOWN, KC_RGHT, KC_LCTL, KC_LGUI, KC_LALT, KC_SPC,  KC_RALT, KC_LGUI, MO(2), KC_LCTL
    ),
...
void housekeeping_task_user(void) {
    ...
    rgblight_setrgb_range(red, green, blue, 14,17);
}
